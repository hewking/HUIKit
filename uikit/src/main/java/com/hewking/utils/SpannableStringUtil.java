...
public class SpannableStringUtil {
     ...
     * @return {@link Builder}
     */
    public static Builder getBuilder(@NotNull Context context, @NonNull CharSequence text) {
    ...
    public static class Builder {
        ...
        private Builder(@NotNull Context context, @NonNull CharSequence text) {
            this.text = text;
        ...
        private void setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    ...
                    mBuilder.setSpan(new ImageSpan(context, resourceId, imageSpanAlign), start, end, flag);
                    resourceId = 0;
