...
/*    public static Drawable generateRoundBorderDrawable(float radii, float borderWidth,
        ...
        return generateRoundBorderDrawable(radii, borderWidth, pressColor,
                ContextCompat.getColor(App.getContext(), R.color.default_base_bg_disable), defaultColor);
    }*/
...
//        array.recycle();
    ...
    public static Drawable generateGradientDrawable(float radius, int startColor, int endColor) {
        GradientDrawable drawable = new GradientDrawable();
