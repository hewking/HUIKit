...
import com.hewking.demo.DemoApplication;
    ...
    public static class Builder {
        ...
        private void setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new ImageSpan(DemoApplication.Companion.getContext(), bitmap), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                    ...
                    mBuilder.setSpan(new ImageSpan(DemoApplication.Companion.getContext(), uri), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
